...
The final project me and my teammates are working on for my ICS 314 class, supports the basis of the architect's blueprint. For instance, when working with files that involve the API, the GET function allows a clear and repeatable structure: authenticate the user, get data, and properly respond to display the right things we wanted to see. 
