...
layout: essay
type: essay
title: "Lost in Code (and how to get out)"
...
<img width="1000px" src="../img/handover_coding.png">
...
Treat coding like a form of literature: not only make a good use of syntax, structure, or semantics, but also the purpose (message) it is capable of bringing — is a great lesson I learned off my fellow friend and coder, who’s now graduated by the time I am writing this. I took it with pride to all my projects since, realizing that clear documentation was essential for long-term understanding of my work. It narrates me through the gist of exhaustive information of my code, in a coherent yet simple explanation. For my peers who want to improve their talent, having a look at my code, with all of the standards followed, would benefit them with loads of valuable information that can last them for years to come. 

Do I enjoy it? Yes, but it can get repetitive if I have loads of functions and variables. Will I use this ever again in my career? Absolutely yes. It would be a shocker to say no to it. Do I expect everyone to follow it? Yes because I want to enjoy the behind-the-scenes operations of the project, and for them to adhere pleases me a lot.

## Setting Up Standards with ESLint

In an effort to recognize the importance of coding standards, I started experimenting with ESLint on my VS Code, a code analysis tool that identifies patterns or code that doesn't adhere to certain style guidelines set by the extension. 

I experimented by extracting the contents of my TypeScript code from the other day for my Software Engineering class onto the editor. When I originally turned in the assignment, there were no red squiggly lines under my variables and/or functions — because it was before ESLint — implying that the code was okay to deploy. After installing ESLint, there came a flood of red squiggly lines. I originally had doubts over whether what I did originally was accurate or matched up with industry standards from witnessing them. But after fixing all of them, I soon realized that the extension was actually saving me from future headaches. And I can’t appreciate it enough.

<img width="250px" src="../img/eslint.png">

ESLint acted as my real-time partner and mentor, ensuring that my code remained readable and professional. More importantly, it taught me that coding standards aren't about restricting creativity, but about creating a common language that any developer can speak, like English, which the majority of the world is able to converse in. I moved closer toward being a contributor who values the longevity and maintainability of the software we build for today and for the future.  

Using ESLint is all about respect—respect for the people you work with, and respect for your future self who will eventually have to return to that code months later whenever he struggles to catch up to his craft.
